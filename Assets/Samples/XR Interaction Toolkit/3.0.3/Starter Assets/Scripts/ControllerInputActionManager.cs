...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ControllerInputActionManager : MonoBehaviour
    {
        ...
        void SetupInteractorEvents()
        {
            ...
            var menuAction = GetInputAction(m_Menu);
            if (menuAction != null)
            {
                menuAction.started += OnStartLocomotion;
                menuAction.canceled += OnStopLocomotion;
            }
        ...
        static void EnableAction(InputActionReference actionReference)
        {
            ...
            Debug.Log("YYYYYYYYYYYYYYYYYYYY");
